...
//  1. Tipo de vehículo (define los precios de cada ítem).
//  2. Paquete predefinido (precarga ítems) o manual (arranca vacío).
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3">
        {paquetes.map((paq) => {
          ...
          return (
            <button
              ...
              id={`wiz-paq-${paq.id}`}
              type="button"
              onClick={() => onComplete(tipoAutoId, paq)}
        ...
        <button
          id="wiz-manual"
          type="button"
          onClick={() => onComplete(tipoAutoId, null)}
